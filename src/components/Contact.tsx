            ...
            <div className="space-y-8 fade-in-up">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">swastikaroytitu@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+91 80926 81269</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Durgapur, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex gap-4">
                  <a 
                    href="https://github.com/Swastika-Roy"
                    target="_blank" 
                  ...
                  <a 
                    href="https://www.linkedin.com/in/swastika-roy-692aa72b4/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors duration-200"
                  >
